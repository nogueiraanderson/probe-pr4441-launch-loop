#!/usr/bin/env bash
# The sh block of pmm/v3/vars/runSpotInstance.groovy at PR 4441 head fd191278, verbatim.
# Jenkins runs it as "sh -xe", so this file is executed with "bash -e" by repro.sh.
set -o xtrace
